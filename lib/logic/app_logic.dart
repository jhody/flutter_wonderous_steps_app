...
import 'package:yleon/ui/common/modals/fullscreen_video_viewer.dart';
...
class AppLogic {
  ...
  Future<void> bootstrap() async {
    ...
    // Wonders Data
    //wondersLogic.init();//yhody

    // Events
    //timelineLogic.init();//yhody

    // Collectibles
    //collectiblesLogic.init();//yhody
    //await collectiblesLogic.load();//yhody

    // Wait at least 1 frame to give GoRouter time to catch the initial deeplink
    //await Future.delayed(1.milliseconds);//yhody
    ...
    if (showIntro) {
      ...
      //appRouter.go(initialDeeplink ?? ScreenPaths.home);//yhody
    }
  }
